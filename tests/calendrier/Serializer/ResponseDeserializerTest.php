...
class ResponseDeserializerTest extends AbstractTestCase {
    ...
    /**
     * Tests deserializeJoursFeriesResponse()
     *
     * @return void
     */
    public function testDeserializeJoursFeriesResponse(): void {
        ...
        // Set a filename mock.
        $filename = realpath(__DIR__ . "/../Fixtures/Response/JoursFeriesResponse.json");
     ...
     * @return void
     */
    public function testDeserializeJoursFeriesResponseWithEmpty(): void {
